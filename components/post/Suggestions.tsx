    ...
    return (
        <>
            {authorSuggestions.length > 0 && (
                <section className="mt-24">
                    <div className="max-w-6xl mx-auto px-4">
                        <h2 className="text-4xl font-bold mb-10 text-left text-gray-900 dark:text-white">More from {post.author}</h2>
            ...
            {otherSuggestions.length > 0 && (
                 <section className="mt-24">
                     <div className="max-w-6xl mx-auto px-4">
                        <h2 className="text-4xl font-bold mb-10 text-left text-gray-900 dark:text-white">Suggested for you</h2>
                        <div className="grid grid-cols-2 lg:grid-cols-3 gap-10">
