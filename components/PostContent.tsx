...
const BLOG_CONTENT: Record<number, React.ReactNode> = {
    1: (
        <>
            ...
            <div className="mb-10">
                <h2 className="text-3xl font-bold text-white mb-4">1. The Component Model</h2>
...
// <Welcome />`}
            ...
            <div className="mb-10">
                <h2 className="text-3xl font-bold text-white mb-4">2. Props: Passing Data</h2>
                <p className="leading-loose mb-6">
...
// <Welcome name="Samantha" />`}
             ...
             <div className="mb-10">
                <h2 className="text-3xl font-bold text-white mb-4">3. State: Managing Component Memory</h2>
                <p className="leading-loose mb-6">
  ...
  return (
    <div>
      ...
      <button onClick={() => setCount(count + 1)}>
        Click me
            ...
            <div>
                <h2 className="text-3xl font-bold text-white mb-4">Sources</h2>
    ...
    2: (
        <>
            ...
            <h3 className="text-3xl font-bold text-white mt-8 mb-4">Mapped Types</h3>
...
// user.age = 31;`}
            ...
            <h3 className="text-3xl font-bold text-white mt-8 mb-4">Conditional Types</h3>
...
type Result2 = IsAnimal<string>; // type is "no"`}
    ...
    3: (
        <>
            ...
            <h3 className="text-3xl font-bold text-white mt-8 mb-4">Thinking in Utilities</h3>
...
<button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
  Click Me
            ...
            <h3 className="text-3xl font-bold text-white mt-8 mb-4">Responsive Design Made Easy</h3>
  ...
  <div class="md:flex">
    ...
    5: (
        <>
            ...
            <h3 className="text-3xl font-bold text-white mt-8 mb-4">Setting Up Your First Server</h3>
...
app.listen(port, () => {
  console.log(\`Server running at http://localhost:\${port}\`);
            ...
            <h3 className="text-3xl font-bold text-white mt-8 mb-4">Defining Routes for a REST API</h3>
  ...
  res.status(201).json(newUser);
    ...
    6: (
        <>
            ...
            <h3 className="text-3xl font-bold text-white mt-8 mb-4">Key Benefits of Microservices</h3>
            ...
            <h3 className="text-3xl font-bold text-white mt-8 mb-4">The Challenges to Consider</h3>
    ...
    7: (
        <>
            ...
            <h3 className="text-3xl font-bold text-white mt-8 mb-4">Code-First GraphQL</h3>
            ...
            <h3 className="text-3xl font-bold text-white mt-8 mb-4">Building a GraphQL Resolver</h3>
...
// that has a findAll method to fetch your data.`}
    ...
    8: (
        <>
            ...
            <h3 className="text-3xl font-bold text-white mt-8 mb-4">The Core Idea: A Centralized Store</h3>
            ...
            <h3 className="text-3xl font-bold text-white mt-8 mb-4">Creating Your First Store</h3>
...
export default useCounterStore;`}
            ...
            <h3 className="text-3xl font-bold text-white mt-8 mb-4">Using the Store in a Component</h3>
  ...
  return (
    ...
    9: (
        <>
            ...
            <h3 className="text-3xl font-bold text-white mt-8 mb-4">The \`motion\` Component</h3>
...
function MyComponent() {
  return (
    ...
    />
            ...
            <h3 className="text-3xl font-bold text-white mt-8 mb-4">Variants for Reusable Animations</h3>
  ...
  return (
    ...
    10: (
        <>
            ...
            <h3 className="text-3xl font-bold text-white mt-8 mb-4">Filesystem-based Routing</h3>
            ...
            <h3 className="text-3xl font-bold text-white mt-8 mb-4">Loading Data</h3>
  ...
  {/each}
    ...
    11: (
        <>
            ...
            <h3 className="text-3xl font-bold text-white mt-8 mb-4">The \`database/sql\` Package</h3>
            ...
            <h3 className="text-3xl font-bold text-white mt-8 mb-4">Connecting and Querying</h3>
...
func main() {
    ...
    12: (
        <>
            ...
            <h3 className="text-3xl font-bold text-white mt-8 mb-4">The Structure of a JWT</h3>
            ...
            <h3 className="text-3xl font-bold text-white mt-8 mb-4">JWT Authentication Flow in Node.js</h3>
  ...
  res.json({ message: \`Welcome \${req.user.username}\` });
    ...
    13: (
        <>
            ...
            <h3 className="text-3xl font-bold text-white mt-8 mb-4">How Lambda Works</h3>
            ...
            <h3 className="text-3xl font-bold text-white mt-8 mb-4">The Lambda Handler</h3>
...
const PostContent: React.FC<PostContentProps> = ({ postId }) => {
    return (
        <article className="prose prose-invert lg:prose-xl max-w-6xl mx-auto mt-16">
